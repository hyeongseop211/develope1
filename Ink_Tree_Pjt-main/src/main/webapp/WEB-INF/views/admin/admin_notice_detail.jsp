...
<link rel="stylesheet" type="text/css" href="/resources/css/admin_notice_detail.css">
<script src="/resources/js/admin_notice_datail.js"></script>
</head>
<body>
...
<%-- 	                        <a href="/download?fileId=${attachment.id}" class="attachment-link"> --%>
