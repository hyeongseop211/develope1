...
public interface TradeFavoriteDAO {
    // 관심목록 추가
    public int addFavorite(TradeFavoriteDTO wishlistDTO);
    
    // 관심목록 삭제
    public int removeFavorite(TradeFavoriteDTO wishlistDTO);
    ...
    public int checkFavorite(TradeFavoriteDTO wishlistDTO);
}
