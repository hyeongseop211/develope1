		...
		<div class="container">
			...
			<div class="progress-container">
				<div class="progress-bar">
					...
					<div class="step">2<span class="step-label">이메일 인증</span></div>
					<div class="step">3<span class="step-label">가입 완료</span></div>
				</div>
			</div>
...
<!--				pattern="^(?=.*[a-zA-Z])(?=.*\d)(?=.*[!@#$%^&*]).{6,16}$"-->
				...
				<div class="button-group">
					...
					<input type="button" value="뒤로가기" onclick="location='/loginView'" class="btn btn-secondary">
				</div>
			</form>
		</div>
