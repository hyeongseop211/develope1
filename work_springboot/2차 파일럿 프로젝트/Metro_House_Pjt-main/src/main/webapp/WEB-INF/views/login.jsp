...
<!-- 		</div> -->
		...
		<form method="post" action="/login" class="login-form"
			...
			<div class="button-group">
				<input type="submit" value="로그인" class="btn btn-primary"> <input
					type="button" value="회원가입" onclick="location='/joinView'"
		...
		<div class="login-options">
			...
			<div class="social-login">
				<a href="/oauth/naver" class="social-btn"> <img
					src="/resources/images/naver-icon.png" alt="네이버 로그인"
					onerror="this.src='/resources/images/naver-default.png'; this.onerror=null;">
				</a> <a href="/oauth/kakao" class="social-btn"> <img
					src="/resources/images/kakao-icon.png" alt="카카오 로그인"
					onerror="this.src='/resources/images/kakao-default.png'; this.onerror=null;">
				</a> <a href="/oauth/google" class="social-btn"> <img
					src="/resources/images/google-icon.png" alt="구글 로그인"
					onerror="this.src='/resources/images/google-default.png'; this.onerror=null;">
				</a>
			</div>

			<p>
				메트로하우스 회원이 아니신가요? <a href="/joinView"
